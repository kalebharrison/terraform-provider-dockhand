...
This repository uses an **agent-managed workflow**: Cursor Cloud Agents implement changes, GitHub Actions validate and open pull requests, and **automation** handles squash merge, release lens review, and release publishing (`docs/AGENT_AUTONOMY.md`).
...
5. **Agent Release Tag** publishes GitHub releases when the automated release lens verdict clears
