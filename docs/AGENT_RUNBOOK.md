...
| `agent-merge-followup.yml` | after Agent PR Approve CI on agent branches | Dispatches merge cleanup and Release Drafter when GITHUB_TOKEN merges skip push triggers |
