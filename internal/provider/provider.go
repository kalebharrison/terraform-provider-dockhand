...
func (p *dockhandProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewLicenseResource,
		NewRegistryResource,
		NewRegistryImageDeleteActionResource,
		NewGitCredentialResource,
		NewGitRepositoryResource,
		NewGitRepositoryTestActionResource,
		NewGitStackResource,
...
func (p *dockhandProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewRegistrySearchDataSource,
		NewRegistryTagsDataSource,
		NewRegistryCatalogDataSource,
		NewGitCredentialsDataSource,
		NewGitPreviewEnvDataSource,
		NewGitRepositoriesDataSource,
		NewNotificationsDataSource,
		NewConfigSetsDataSource,
		NewEnvironmentsDataSource,
		NewEnvironmentDetectSocketDataSource,
		NewNetworksDataSource,
		NewVolumesDataSource,
		NewImagesDataSource,
		NewSchedulesDataSource,
		NewScheduleSettingsDataSource,
		NewScheduleStreamDataSource,
		NewSchedulesExecutionsDataSource,
		NewSystemDataSource,
		NewSystemDiskDataSource,
		NewSystemFilesDataSource,
		NewSystemFileContentDataSource,
