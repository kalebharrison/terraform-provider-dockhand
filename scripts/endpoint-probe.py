...
ENDPOINTS: List[Dict[str, Any]] = [
    ...
    {"method": "GET", "path": "/api/settings/navigation"},
    ...
    {"method": "POST", "path": "/api/prune/all", "with_env": True},
    {"method": "POST", "path": "/api/prune/containers", "with_env": True},
    {"method": "POST", "path": "/api/prune/images", "with_env": True},
    {"method": "POST", "path": "/api/prune/networks", "with_env": True},
    {"method": "POST", "path": "/api/prune/volumes", "with_env": True},
...
def main() -> int:
    ...
    with open(out_md, "w", encoding="utf-8") as f:
        ...
        f.write("Generated by `scripts/endpoint-probe.py` on GitHub Actions (Dockhand Compat).\n")
        f.write("Refreshed on `main` by **Compat Reports Sync** — see `docs/CI_AND_RELEASE.md`.\n\n")
